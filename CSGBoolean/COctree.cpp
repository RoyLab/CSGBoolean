...
namespace CSG
{
    ...
    static void BuildOctree2(OctreeNode* root, Octree<MPMesh2>* pOctree, int level)
    {
        assert(root && pOctree);
    ...
    Octree<MPMesh2>* BuildOctree2(MPMesh2** meshList, unsigned num)
    {
        if (!num) return NULL;

        Octree<MPMesh2>* pOctree = new Octree<MPMesh2>;
